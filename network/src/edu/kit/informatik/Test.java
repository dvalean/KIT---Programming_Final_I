...
public class Test {
    public static void main(String[] args) throws ParseException {
        ...
        System.out.println(a.compareTo(root));
        ...
        // // true
        // System.out.println(List.of(new IP("0.146.197.108"), new IP("39.20.222.120"), new IP("77.135.84.171"),
        //         new IP("85.193.148.81"), new IP("116.132.83.77"), new IP("122.117.67.158"), new IP("141.255.1.133"),
        //         new IP("231.189.0.127"), new IP("252.29.23.0")).equals(network.list()));
    }
}
